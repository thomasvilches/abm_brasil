...
for city in states
    for i in b
        ...
        run_param_fixed(city,[10;20;30],1.0,1.0,true,0.94,1.0,0.0,0.0,300,i,0.57,60,[14;7])
        run_param_fixed(city,[10;20;30],1.0,1.0,true,0.94,0.5,0.0,0.0,300,i,0.57,60,[14;7])
        run_param_fixed(city,[10;20;30],1.0,1.0,true,0.94,0.0,0.0,0.0,300,i,0.57,60,[14;7])

        #!##supposing that vaccine protects 100% agains severe disease
        run_param_fixed(city,[10;20;30],1.0,1.0,true,0.94,1.0,0.0,1.0,300,i,0.57,60,[14;7])
        run_param_fixed(city,[10;20;30],1.0,1.0,true,0.94,0.5,0.0,1.0,300,i,0.57,60,[14;7])
        run_param_fixed(city,[10;20;30],1.0,1.0,true,0.94,0.0,0.0,1.0,300,i,0.57,60,[14;7]) 
