...
Vac_efs = c("0", "5038", "7042", "86") # efficacy against symptomatic
...
create_df <- function(n, folder, type, beta, herdi, Vaccine = "No Vaccine", redp = "0.0", risk_red = "0.0", ef_sev = "0.0", vac_rate = 300, ag = "all"){
